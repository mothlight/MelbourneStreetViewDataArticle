...
\begin{figure}[!htbp]
	...
	\caption{Coverage of the Melbourne GSV imagery dataset.}
	\label{fig:coverage}  
\end{figure} 

The data archive contains a CSV file that provides an overview of all image names, the latitude and longitude coordinates of the associated locations, the location number (see Sect.~\ref{sec:create}), and the street name. All JPG files follow the naming convention LocationNumber\_Latitude\_Longitude\_Heading.jpg (e.g., VIC9984261\_-37.683250063\_145.05143251199999\_90.jpg) and images for the four headings are saved in the directory structure:
...
\begin{figure}[!htbp]
	...
	\caption{Sample GSV imagery at (-37.932723004, 145.032732984) for headings 0, 90, 180, and 270 degrees, respectively.}
	\label{fig:sample}  
\end{figure} 
